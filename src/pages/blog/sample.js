      ...
      <div className={styles.root}>
        <Container>
          <div className={styles.blogContainer}>
            <Blog
              category={'design'}
              title={'Friends of Store2Door: Flora Fricker'}
            ...
            >
              <div className={styles.content}>
                ...
                <p className={styles.blogParagraph}>
                  Store2Door collects personal information that you voluntarily provide when
                  applying or registering for an account with The Upside or
                  making a purchase on The Upside website.
                </p>
                <p className={styles.blogParagraph}>
              ...
              <div className={styles.content}>
                ...
                <p className={styles.blogParagraph}>
                  Store2Door collects, uses and discloses information regarding
