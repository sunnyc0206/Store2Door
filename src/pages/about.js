      ...
      <div className={styles.root}>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.detailContainer} ref={historyRef}>
            <p>
              Store2Door is an innovative Indian-British brand with a
            ...
            <p>
              ...
              that makes T-shirts in its own factory.
            </p>
          </div>
        </Container>
        ...
        <Container size={'large'} spacing={'min'}>
          <div className={styles.content}>
            ...
            <div ref={valuesRef}>
              <p>
                BrandBySunny produced some of the world's earliest T-shirts. In the
