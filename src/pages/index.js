  ...
  return (
    <Layout disablePaddingBottom>
      ...
      <div className={styles.messageContainer}>
        ...
        <p>
          wear by <span className={styles.gold}>Store2Door</span> and{' '}
          <span className={styles.gold}>BrandBySunny</span>
        </p>
      </div>
      ...
      <div className={styles.socialContainer}>
        <Title
          name={'Styled by You'}
          subtitle={'Tag @Store2Door to be featured.'}
        />
